        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="onSubmit" v-show="currentStep === 1">Create</el-button>
                        <el-button>Cancel</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        <div class="container" v-show="currentStep >= 2">
            <div class="form-box">
                <el-form ref="form" :model="smallInfo" label-width="80px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="onSubmit2" v-show="currentStep === 2">Save This Part
                        </el-button>
                        <el-button>Cancel</el-button>
                    </el-form-item>
                </el-form>
                ...
                <el-form ref="form" :model="brefSchedule" label-width="80px">
                    ...
                    <el-form-item label="Moday">
                        <el-select v-model="brefSchedule.mo" placeholder="duration">
                            <el-option v-for="item in scheduleItem" :key="item.id" :label="item.content" :value="item.content"></el-option>
                        </el-select>
                    </el-form-item>
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="onSubmit2" v-show="currentStep === 3">Save This Part
                        </el-button>
                        <el-button>Cancel</el-button>
                    </el-form-item>
                </el-form>
